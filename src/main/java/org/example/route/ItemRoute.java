...
public class ItemRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("direct:writeTrendXml")
                ...
                .to("file://{{app.output.item-trend-analyzer}}?fileExist=Ignore")
                .log(LoggingLevel.INFO, "Saved trend XML: ${header.CamelFileName}")
        ...
        from("direct:writeReviewXml")
                ...
                .to("file://{{app.output.item-review-aggregator}}?fileExist=Ignore")
                .log(LoggingLevel.INFO, "Saved review XML: ${header.CamelFileName}")
                .doCatch(Exception.class)
        ...
        from("direct:writeStoreJson")
                ...
                .doTry()
                .marshal(jsonFormat)
                .to("file://{{app.output.storefront-app}}?fileExist=Ignore")
                .log(LoggingLevel.INFO, "Saved store JSON: ${header.CamelFileName}")
                .doCatch(Exception.class)
